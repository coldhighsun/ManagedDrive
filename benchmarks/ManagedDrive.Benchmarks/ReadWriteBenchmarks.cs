...
[MemoryDiagnoser]
[MinColumn, MaxColumn]
public class ReadWriteBenchmarks
{
    private const ulong CapacityBytes = 128 * 1024 * 1024;
    private const string RamMountPoint = "R:";
    ...
    [Params(4 * 1024, 1 * 1024 * 1024, 64 * 1024 * 1024)]
    ...
    public void Setup()
    {
        ...
        _ramFile = Path.Combine(RamMountPoint + @"\", "bench.dat");
